...
export type EventValue = EventPrimitive | EventValue[] | {
...
export type PromotionStorageState = "overflow_only" | "promoting" | "promoted" | "failed";
export type InferredAttributeType = "BOOLEAN" | "BIGINT" | "DOUBLE" | "VARCHAR" | "JSON";
