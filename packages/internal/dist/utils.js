...
export function isBaselineColumn(field) {
    return BASELINE_COLUMN_NAMES.includes(field);
}
export function isPrimitiveEventValue(value) {
    return (value === null ||
        typeof value === "string" ||
        typeof value === "number" ||
        typeof value === "boolean");
}
export function isPromotionHintAttribute(key, value) {
    return key.startsWith(PROMOTION_HINT_PREFIX) && value === true;
}
export function getPromotionHintKey(key) {
    return key.slice(PROMOTION_HINT_PREFIX.length);
}
export function parseDurationWindow(value) {
...
export function normalizeEventPrimitive(value) {
    if (value === null ||
        typeof value === "string" ||
        typeof value === "number" ||
        typeof value === "boolean") {
