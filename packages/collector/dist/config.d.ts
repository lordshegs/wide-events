...
export declare const collectorConfigSchema: z.ZodObject<{
    ...
    maxPromotedColumns: z.ZodDefault<z.ZodNumber>;
    promotionIntervalMs: z.ZodDefault<z.ZodNumber>;
    promotionMinRows: z.ZodDefault<z.ZodNumber>;
    promotionMinRatio: z.ZodDefault<z.ZodNumber>;
    promotionMaxKeysPerRun: z.ZodDefault<z.ZodNumber>;
