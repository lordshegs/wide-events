import { getPromotionHintKey, isPromotionHintAttribute } from "../index.js";
...
export function flattenSpan(resourceAttributes, span) {
    ...
    const row = createBaseRow(span, traceId, spanId, startTime, durationMs);
...
function createBaseRow(span, traceId, spanId, startTime, durationMs) {
    const row = {
        trace_id: traceId,
        span_id: spanId,
