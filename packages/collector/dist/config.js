...
export function readCollectorConfig(env = process.env) {
    return collectorConfigSchema.parse({
        ...
        promotionIntervalMs: parseInteger(env["WIDE_EVENTS_PROMOTION_INTERVAL_MS"], 300_000),
        ...
        promotionMaxKeysPerRun: parseInteger(env["WIDE_EVENTS_PROMOTION_MAX_KEYS_PER_RUN"], 1),
